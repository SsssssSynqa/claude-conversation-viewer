/**
 * SVG Icon System — Lucide icons (ISC license), unified style.
 * All icons: 24x24 viewBox, stroke-width 2, round linecap/linejoin.
 */
...
export const icons = {
  ...
  moon: svg('<path d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9z" stroke-width="1.5"/>'),
  ...
  export: svg('<path d="M12 15V3"/><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><path d="m7 10 5 5 5-5"/>'),
  ...
  thought: svg('<path d="M2.992 16.342a2 2 0 0 1 .094 1.167l-1.065 3.29a1 1 0 0 0 1.236 1.168l3.413-.998a2 2 0 0 1 1.099.092 10 10 0 1 0-4.777-4.719"/>'),
  ...
  zip: svg('<rect width="20" height="5" x="2" y="3" rx="1"/><path d="M4 8v11a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8"/><path d="M10 12h4"/>'),
  ...
  selectAll: svg('<rect width="18" height="18" x="3" y="3" rx="2"/><path d="m9 12 2 2 4-4"/>'),
  ...
  // Claude flower/spark — simple 8-ray asterisk
  flower: svg('<path d="M12 3v18"/><path d="M3 12h18"/><path d="m5.63 5.63 12.74 12.74"/><path d="m18.37 5.63-12.74 12.74"/>'),
};

/**
 * Create an icon element (safe: all SVG is hardcoded Lucide content).
